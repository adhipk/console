...
# restore the original directory
  ...
  echo "  3) Pimoroni Inky Impression Spectra 7.3\" (800x480)"
  echo "  4) Pimoroni Inky Impression 5.7\" (600x448, 7-color)"
  read n
  JSTART=$(printf "{\n        \"adapter\": \"")
  ...
  case $n in
	  ...
	  2) JADAPTER="waveshare_2"
          ...
          4) JADAPTER="pimoroni"
             PANEL2="EP57_SPECTRA_600x448"
             PANEL="EP57_SPECTRA_600x448";;
