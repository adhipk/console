...
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT USAGE, SELECT ON SEQUENCES TO byos_app;`,
	...
	"0010_add_display_type": {
		title: "Add Display Type Setting",
		description:
			"Adds display_type column to devices table for distinguishing between black/white, grayscale, and color e-ink displays",
		sql: `-- Add display_type column
ALTER TABLE devices
